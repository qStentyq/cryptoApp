        ...
        <>
            <div className='product-container'>
                {fetchData.map((item, i) => (
                    <h2 key={i}>
                        <Link to={`/store/${item.id}`} className='product-card'>
                            <img
            ...
            <div className='checkout'>
                <div className='checkout__sum'>For pay: {sum} MDL</div>
                <button className='button-44' onClick={handleBuy}>
                    Buy items from cart
                </button>
                <button
                    className='button-44 button-45'
                    onClick={() => {
                        setCartItems([]);
                        setSum(0);
                    }}
