               ...
               <Card hoverable className='news-card'>
                 <a href={news.url} target="_blank" rel="noreferrer">
                   <div className='news-image-container'>
                     ...
                     <img src="https://assets.finbold.com/uploads/2024/02/Best-life-changing-cryptocurrency-to-buy-in-2024.jpg" 
                     alt="article image" className="newsimg"/>
                   </div>
                   <p>
                    Article by {news?.publisher?.name}
                   </p>
                 </a>
               </Card>
             </Col>
