    ...
    return (
        <form>
            <p className='decorText'>
                Выберите тип новостей, которые хотите получить: <br />
                <br></br>
                <label>
                ...
                <label>
                    Bitcoin news:{" "}
                    <input type='checkbox' name='bitcoin' onChange={changeNewsTypes} defaultChecked={bitcoinCheck} />
                </label>
                <br />
                <label>
                ...
                <label>
                    Solana news:{" "}
                    <input type='checkbox' name='solana' onChange={changeNewsTypes} defaultChecked={SolanaCheck} />
                </label>
                <br />
                <button type='button' onClick={sendNewsBtn}>
                    {" "}
                    Отправить рассылку новостей{" "}
                </button>
                <br />
                <br />
                <br />
